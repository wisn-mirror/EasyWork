...
/**
 * Created by Wisn on 2018/4/6 下午9:38.
 */
...
public class Movies {
    ...
    public static class SubjectsBean implements MultiItemEntity {
        ...
        public int getItemType() {
            if (rating.average > 8.5f) {
                return GoodMovie;
            } else if (rating.average > 5) {
                return NotBadMovie;
            }
            return BadMovie;
        }
        public static final int GoodMovie = 1;
        public static final int NotBadMovie = 2;
        public static final int BadMovie = 3;
