...
public class DialogAdapter extends BaseMultiItemQuickAdapter<Movies.SubjectsBean,BaseViewHolder> /*implements  BaseQuickAdapter.OnItemClickListener , BaseQuickAdapter.OnItemChildClickListener*/{
    /**
     ...
     */
    public DialogAdapter(List<Movies.SubjectsBean> data) {
        super(data);
