...
WORKSPACE=/Users/mac/Desktop/githubworkspace/SmartBi/app
...
backup_Dir=/Users/mac/Desktop/Version/edutianpanbackup
BuildLog=/Users/mac/Desktop/Version
cd ${WORKSPACE}
cd ..

echo 开始打包
gradle clean assembleRelease | grep -v 'EduTianpanbuildlog.txt' > ${BuildLog}/EduTianpanbuildlog.txt
...
done <${BuildLog}/EduTianpanbuildlog.txt
...
uploadPath=${WORKSPACE}/build/outputs/duiqi/${apkName}
